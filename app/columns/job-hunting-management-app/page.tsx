      ...
      <article className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_360px] lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black leading-tight sm:text-5xl">
              就活管理アプリおすすめ｜
              <span className="text-blue-600">ES・面接・締切を一括管理</span>
            </h1>

            <p className="mt-8 text-lg leading-9 text-slate-600">
              就活では、企業情報、ES、面接予定、説明会、Webテスト、締切、
              マイページ情報などを同時に管理する必要があります。
        ...
        <section className="mt-14">
          ...
          <p className="mt-6 text-lg leading-9 text-slate-600">
            就活管理アプリを使うと、企業情報、ES、面接予定、締切、メモを
            スマホでまとめて管理できます。特に複数企業を並行して受ける場合、
            情報を一か所に集約することで確認漏れを減らせます。
          </p>
        ...
        <section className="mt-16 rounded-[2rem] bg-gradient-to-br from-blue-600 to-cyan-500 p-8 text-white shadow-xl">
          ...
          <p className="mt-5 leading-9 text-blue-50">
            My就活は、企業管理、ES管理、面接予定、締切管理、就活ニュース、
            就活サービスをまとめて使える就活管理アプリです。
